            ...
            {kind === "e2b" ? (
              <>
                ...
                <p className="mt-1.5 text-[12px] leading-relaxed text-muted-foreground">
                  <Trans>
                    Leave CPU and memory blank to keep the base template's resources. Set both to
                    make Rakazo build and reuse a sized template. A blank base template uses E2B's
                    desktop template.
                  </Trans>
                </p>
              </>
              ...
              <p className="text-[12px] leading-relaxed text-muted-foreground">
                <Trans>
                  CPU and memory are optional. Blank values use the deployment-wide Docker defaults.
                </Trans>
              </p>
            )}
          </div>
